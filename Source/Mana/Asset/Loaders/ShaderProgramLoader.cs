...
namespace Mana.Asset.Loaders
{
    public class ShaderProgramLoader : IAssetLoader<ShaderProgram>
    {
                                  ...
                                  string sourcePath)
        {
            ...
            // Keep track of paths used in #include statements for asset reloading.
            var usedIncludePaths = new List<string>();
                ...
                where T : Shader
            {
                ...
                shaders.Add(GetShader(assetManager,
                                      renderContext,
                                      containingPath,
                                      relativeShaderPath,
                                      factory,
                                      out var includePaths));

                usedIncludePaths.AddRange(includePaths);
            }
            ...
            program.ShaderIncludePaths = usedIncludePaths.ToArray();
            ...
            where T : Shader
        {
            lock (assetManager.AssetLock)
            {
                ...
                shaderSource = ShaderPreprocessor.Process(assetManager, path, out shaderIncludePaths);

                var shader = factory(renderContext, shaderSource);
