...
namespace Mana.Graphics
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        /// <summary>
        /// Translates an html color representation to a Mana color.
        /// </summary>
        ...
        public (double hue, double saturation, double value) ToHSV()
        {
            ...
            var drawingColor = System.Drawing.Color.FromArgb(255, R, G, B);
            
            double hue = drawingColor.GetHue();
        ...
        /// <summary>
        /// Translates an HSV color into a Mana color.
        /// </summary>
