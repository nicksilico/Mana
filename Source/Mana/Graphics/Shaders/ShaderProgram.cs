...
namespace Mana.Graphics.Shaders
{
    ...
    /// </summary>
    public partial class ShaderProgram : GLResource, IReloadableAsset
    {
        ...
        {
            BoundContext = null;
            renderContext.EnsureShaderProgramUnbound(this);
        }
        ...
        public string[] ShaderIncludePaths { get; set; }
        ...
        public void Reload(AssetManager assetManager)
        {
            ...
            var loader = AssetManager.AssetLoaders[typeof(ShaderProgram)] as ShaderProgramLoader
                         ?? throw new InvalidOperationException("Cannot reload ShaderProgram.");

            try
            {
                using var stream = assetManager.GetStreamFromPath(SourcePath);

                var createdProgram = loader.Load(assetManager, assetManager.RenderContext, stream, SourcePath);
        ...
        public string[] GetLiveReloadAssetPaths()
        {
            ...
            paths.AddRange(ShaderSourcePaths);
            paths.Add(SourcePath);
            paths.AddRange(ShaderIncludePaths);
