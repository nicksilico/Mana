...
{
    public class LineBatch2D : IDisposable
    {
        ...
        private void Flush()
        {
            if (ShaderProgram == null)
                throw new InvalidOperationException("Cannot flush LineBatch2D with Shader set to null.");
            ...
            _vertexBuffer.VertexTypeInfo.Apply(ShaderProgram);
