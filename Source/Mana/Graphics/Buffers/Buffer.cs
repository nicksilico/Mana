...
namespace Mana.Graphics.Buffers
{
    ...
    public abstract class Buffer : GLResource
    {
        ...
        /// <summary>
        /// Gets a value indicating if the buffer is mapped.
        /// </summary>
        public bool IsMapped { get; private set; }

        /// <summary>
        /// Gets the location of the mapped memory of the buffer, or IntPtr.Zero if unmapped.  
        /// </summary>
        public IntPtr MapLocation { get; private set; } = IntPtr.Zero;
