...
namespace Mana.Graphics
{
    ...
    public static class GLInfo
    {
        ...
        public static bool _forceDisableExtensionChecks = true;
        ...
        public static void Initialize()
        {
            ...
            if (_forceDisableExtensionChecks)
            {
                HasDirectStateAccess = false;
                HasBufferStorage = false;
                HasDebug = false;
                HasSeparateShaderObjects = false;
            }

            _initialized = true;

            _log.Info("OpenGL Initialized");
            _log.Info($"OpenGL Version:                  {Str(StringName.Version)}");
            _log.Info($"OpenGL Renderer:                 {Renderer}");
            _log.Info($"OpenGL Shader Language version:  {Str(StringName.ShadingLanguageVersion)}");
            _log.Info($"OpenGL Vendor:                   {Vendor}");
            _log.Info("-------------");
