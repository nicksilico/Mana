...
namespace Mana.IMGUI
{
    public class ImGuiRenderer
    {
        ...
        public ImGuiRenderer(ImGuiSystem imguiSystem, ManaWindow window)
        {
            ...
            Vector2i offset = _window.Location - (ManaWindow.MainWindow.Location + new Vector2i(8, 31));
        ...
        public void RenderCommandLists(RenderContext renderContext, ImDrawDataPtr drawData)
        {
            ...
            for (int n = 0; n < drawData.CmdListsCount; n++)
            {
                ...
                for (int cmdi = 0; cmdi < cmdList.CmdBuffer.Size; cmdi++)
                {
                    ...
                    {
                        var offset = _window.Location - (ManaWindow.MainWindow.Location + new Point(8, 31).ToVector2i());
